                            ...
                            <Animated.View style={{ transform: [{ rotate: props.spin }] }} >
                                {
                                    props.loadingIcon
                                        ...
                                        props.loadingIcon
                                        :
                                        <PlayerIcon iconState={'videoLoading'}/>
                                }
                            </Animated.View>
        ...
        if (props.showLockCont) {
            return (
                <Animated.View
                    ...
                    >
                        {
                            lock ? <PlayerIcon iconState={'videoLocking'}/> : <PlayerIcon iconState={'videoUnlock'}/>
                        }
                    </TouchableOpacity>
                </Animated.View >
            )
        ...
        return (
            <View
                ...
                <View style={
                    ...
                    <PlayerIcon iconState={'videoBrightness'}/>
        ...
        return (
            <View
                ...
                <View style={{
                    ...
                    {
                        soundWidth > 0 ? <PlayerIcon iconState={'videoSound'}/> : <PlayerIcon iconState={'videoNoSound'}/>
                    }
                    <View style={{ backgroundColor: "rgba(255,255,255,0.5)", height: 2, width: 100, marginLeft: 8 }}>
            ...
            <Fragment>
                <View style={{ flexDirection: 'row',position:"relative",width:30 ,alignItems:'center',justifyContent:'center'}}>
                    ...
                    <Animated.View style={{position:'absolute',left:sV,width:20,height:20,alignItems:'center',justifyContent:'center',transform: [{rotateY:isSolTouch?'180deg':"0deg"}]}}>
                        ...
                        <PlayerIcon iconState={'videoFastSpeed'}/>
                    </Animated.View>
