...
import {
    ...
    Lock,
    AnFastSvg
} from '../components/playerComponent.js';
// import {
//     SvgVideoNextBtn,
//     SvgVideoSetting,
//     SvgVideoStop,
                       ...
                       >
                           ...
                           >
                                <Video
                                    key={this.url}
                                    rate={videoRate}
                                    source={{ uri: this.props.route.params.watchItem.media }}
                        ...
                        {this.state.showConts ?
                           ...
                           >
                               ...
                               >
                                    <PlayerIcon iconState={'videoBack'}/>
                                    <Text
                                ...
                                <View style={{ position: "absolute", top: topContsTop, right: smallP ? 5 : this.props.continuous ? 45 : 5, flexWrap: "nowrap", flexDirection: "row", zIndex: 10, }}>
                                   ...
                                   >
                                        {this.props.storeComponent ? this.props.storeComponent() : <PlayerIcon iconState={'videoScang'}/>}
                                    </TouchableOpacity>
                                    <TouchableOpacity style={{ padding: 8, marginLeft: 1, }}
                                        onPress={this.props.onMoreFun && this.props.onMoreFun()}
                                   >
                                        {this.props.moreSetting ? this.props.moreSetting() : <PlayerIcon iconState={'videoSetting'}/>}
                                    </TouchableOpacity>
                                </View>
                            </Animated.View>
                            :
                                    ...
                                    <View style={{ flexDirection: "row", flexWrap: "nowrap" }}>
...

                                        {
                                            this.state.smallP ?
                                               ...
                                               >
                                                    <PlayerIcon iconState={'videoAllBox'}/>
                                                </TouchableOpacity>
                                                : (
                                                   ...
                                                   >
                                                        <PlayerIcon iconState={'videoSmallBox'}/>
                                                    </TouchableOpacity>
                                                )
                                        }
                                    </View>
                                        ...
                                        <View style={{ height: 40, width: stateWidth, paddingHorizontal: 45, flexDirection: "row" }}>
                                            <View style={{ flexDirection: "row", flex: 1, }}>
                                                ...
                                                }
                                                {
                                                   ...
                                                   >
                                                        <PlayerIcon iconState={'videoNextBtn'}/>
                                                    </TouchableOpacity>
                                                }
                                            </View>
